...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Join Channel', url='https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17'),
                InlineKeyboardButton('🧩 Join Group', url='https://t.me/searchkannadamovies'),
            ]
            ]
        await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [Join Channel](https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
