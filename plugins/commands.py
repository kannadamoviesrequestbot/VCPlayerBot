...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17'),
...
async def repo_(client, message):
    buttons = [
        ...
        [
            InlineKeyboardButton("🎞  Develper", url='https://t.me/beereshbanakards'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/kannadamoviesrequestbot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
